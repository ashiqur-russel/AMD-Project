...
?>
	<div class="container">
		<div class = "col-md-12"><h2 style = "text-align: center">Pizza Management</h2></div>
        <div style=" width:100%; border: 1px solid black; margin-bottom : 10px; float : left">
            ...
            <form style="float : left" action="pizza.php" method="post">
                <div class="form-group">
                    <div class="row">
						<div class="col-md-12" style="margin: 10px"><u><h3>Pizza Insertion</h3></u></div>
        ...
        <div style="height:auto; width:100%; border: 1px solid black; float: left">
			<div class="col-md-12" ><u><h3>View Pizza Details</h3></u></div>
            <?php
